...
class NotificationsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: ListView(
          children: [
            ...
            _buildNotificationTile(
              ...
              time: '30 min ago',
              page:
                  UpdateAvailablePage(), // Mengarahkan ke halaman Update Available
            ),
            _buildNotificationTile(
              context,
              title: 'Reminder',
            ...
            const Text(
              ...
              style: TextStyle(
                ...
                fontWeight: FontWeight.bold,
                color: Colors
                    .grey, // Teks abu-abu untuk kategori 'Earlier Notifications'
              ),
            ),
            _buildNotificationTile(
              context,
              ...
              time: 'Yesterday',
              page:
                  AccountSecurityPage(), // Mengarahkan ke halaman Account Security
            ),
            _buildNotificationTile(
              context,
              title: 'Welcome!',
      ...
      backgroundColor:
          const Color(0xFFEADCF8), // Background ungu pastel untuk halaman utama
    );
  }
  ...
  Widget _buildNotificationTile(
    ...
    required Widget
        page, // Menambahkan parameter `page` untuk setiap halaman yang akan dituju
  }) {
    return Card(
      ...
      child: ListTile(
        leading: CircleAvatar(
          backgroundColor: Colors.black.withOpacity(
              0.1), // Lingkaran avatar dengan latar belakang hitam transparan
        ...
        subtitle: Column(
          ...
          children: [
            Text(description,
                style: const TextStyle(color: Colors.black)), // Deskripsi hitam
            const SizedBox(height: 4),
            Text(
              time,
              style: const TextStyle(
                  color: Colors.grey, fontSize: 12), // Waktu berwarna abu-abu
            ),
          ],
        ),
        onTap: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => page), // Navigasi ke halaman yang sesuai
          );
        },
      ),
    );
